          ...
          <div className='signup-form'>
            ...
            <form className='register-form'>
              <div className='fields-group'>
                ...
                {errorMessage.userName && <ErrorMessage error={errorMessage.userName} />}
              ...
              <div className='fields-group'>
                ...
                {errorMessage.RePassword && <ErrorMessage error={errorMessage.RePassword[0]} />}
              </div>
              ...
              <div className='fields-group'>
                <Input
                  ...
                  onHandleChange={handleChange}
                />
                {errorMessage.DisplayName && <ErrorMessage error={errorMessage.DisplayName[0]} />}
              </div>
